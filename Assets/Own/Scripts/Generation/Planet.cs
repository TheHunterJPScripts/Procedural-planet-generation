...
namespace Generation
{
    ...
    */
    public class Planet : MonoBehaviour
    {
        ...
        static public void AddPlanetToQueue(string name, Vector3 position, int seed, bool randomSeed, Style terrainStyle, GenerationData[] generationData, ColorHeight[] colorHeight, Material material, float radius, int subdivisions, int chunckSubdivisions, RuntimeAnimatorController controller)
        {
